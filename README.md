...
graph TD
    ...
    HA -->|Retrieve Context/Data| MA
    HA -->|LLM Reasoning| Groq
...
*   **Command Center** ([CommandCenter.jsx](file:///c:/Users/User/OneDrive/Desktop/4th%20year/Semester%208/mini%20Project/agentic%20project/Artificial-Personal-Digital-Twin/DigitalTwin.Client/src/pages/CommandCenter.jsx)): A command interface to send queries directly to the agent system, visualizing step-by-step task processing.
...
*   **Health Agent** ([health_agent.py](file:///c:/Users/User/OneDrive/Desktop/4th%20year/Semester%208/mini%20Project/agentic%20project/Artificial-Personal-Digital-Twin/DigitalTwin.API/api/v1/endpoints/health/health_agent.py)): Connects to a RAG database containing uploaded medical PDFs, queries the **Memory Agent** to retrieve user context/data, evaluates daily biometric data points, and answers user questions using Groq LLM reasoning.
*   **Memory Agent** ([memory.py](file:///c:/Users/User/OneDrive/Desktop/4th%20year/Semester%208/mini%20Project/agentic%20project/Artificial-Personal-Digital-Twin/DigitalTwin.API/api/v1/endpoints/memory.py)): Manages user preferences, chat logs, and digital memory persistence, providing stored context/data directly to the **Health Agent**.
...
| `GROQ_API_KEY` | Groq Developer API key for Agent reasoning | `gsk_...` |
